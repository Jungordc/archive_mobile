...
>
 */
const MstEditor = React.forwardRef(() => {
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <VStack flex={1}>
                ...
                <OInputTags
                    ...
                    placeholder="Aa"
                    onChange={(tag) => {
                        console.log("MST EDITOR ADD", tag);
                        tagsField.push({ name: tag });
                    }}
                    onRemove={(_, index) => {
                        console.log("MST EDITOR Remove !!!", index);
                        tagsField.removeIndex(index);
                    }}
                />
            </VStack>
            <View>
            ...
            <View flex={1} m="4" ml="16">
                <VStack flex={1} space="3">
                    ...
                    >
                        ...
                        Perspiciatis tempora eligendi enim distinctio unde eaque
                        doloremque! Eum ipsum libero, id sequi odit incidunt
                        voluptates molestiae blanditiis ratione sunt ullam quos.
                    </Text>
                </VStack>
            </View>
        </ScrollView>
